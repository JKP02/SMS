		...
		main_section.setLayout(new BorderLayout(0,0));
			...
			main_para_panel.setLayout(new CardLayout(30,15));
				...
				main_para_grid.setLayout(new GridLayout(2,2,15,20));
					JButton create_btn=new JButton("Add New Teacher");
					...
					JButton read_btn=new JButton("See All Teachers");
						read_btn.addActionListener(new ActionListener()
						{
							public void actionPerformed(ActionEvent e)
							{
								...
								if(ans==null)
								{
									JOptionPane.showMessageDialog(main_section,"Couldn't fetch Teacher data!");
								}
								else if(ans.length==0)
								{
									JOptionPane.showMessageDialog(main_section,"No Teacher Found!");
								}
								else
								{												
					...
					read_btn.setBackground(new Color(51-153-255));
					read_btn.setForeground(create_btn.getForeground());
					read_btn.setBorder(create_btn.getBorder());
					
					JButton update_btn=new JButton("Remove A Teacher");
					...
					update_btn.setBackground(new Color(51-153-255));
					...
					delete_btn.setBackground(new Color(51-153-255));
