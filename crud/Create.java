		...
		main_section.setLayout(new BoxLayout(main_section,BoxLayout.Y_AXIS));
				...
				main_para_panel.setLayout(new BoxLayout(main_para_panel,BoxLayout.Y_AXIS));
					...
					degree_panel.setLayout(new FlowLayout(FlowLayout.RIGHT,80,0));
						JLabel degree=new JLabel("Subject: ");
							...
							main_button.addActionListener(new ActionListener()
									{
										public void actionPerformed(ActionEvent e)
										{
											...
											if(rn.length()<2 && rn.length()>15)
											{
												JOptionPane.showMessageDialog(main_section,"Student RollNo must be of 2 to 15 Digits.");
												return;
											}
											...
											if(!isAlpha(deg))
											{
												JOptionPane.showMessageDialog(main_section,"Subject must not contain numbers or special characters.");
												return;
											}
											if(deg.length()<2 && deg.length()>30)
											{
												JOptionPane.showMessageDialog(main_section,"Subject must be of 2 to 30 Characters.");
												return;
											}
